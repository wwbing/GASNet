...
class Detect(nn.Module):
    ...
    def forward(self, x):
        if self.training:
            ...
            # 颈部三层特征 ，ab分类 , ab坐标4 , af分类 , af分布 ==> 颈部三层特征，(B, 25200, 7)，(B, 25200, 4)，(B, 8400, 7)，(B, 8400, 68)
            # anchor-based输出坐标信息， anchor-free输出分布信息
            return x, cls_score_list_ab, reg_dist_list_ab, cls_score_list_af, reg_dist_list_af   # # x neck输出的特征
