...
class e_lvt(lite_vision_transformer):
    def __init__(self, rasa_cfg=None, with_cls_head=False, **kwargs):
        super().__init__(
            layers=[1,1,2,2],
            patch_size=4,
...
if __name__ == '__main__':
    ...
    checkpoint_path  = r"C:\Users\jiahao\Desktop\JIAHAO\paper_with_code\project\YOLOv6\yolov6\models\lvt_imagenet.pth.tar"
    
    param_dict = torch.load(checkpoint_path)

    model  = e_lvt().to(device)
