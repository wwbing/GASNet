...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default=r'C:\Users\jiahao\Desktop\JIAHAO\paper_with_code\project\Gasnet\weights\pcbori\weights\best_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default=r"C:\Users\jiahao\Desktop\paper\vis\PCBori\ori", help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='./data/pcb-ori.yaml', help='data yaml file.')
