...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default=r'D:\experiment\result\neu\mywork\best_distill\weights\best_ckpt.pt', help='model.pt path(s)')
...
def run(data,
    ...
    return eval_result, vis_outputs, vis_paths       # return ( mAP@0.5, mAP@0.5:0.95) , vis_outputs, vis_paths  后两个给tensorboard可视化
